"""
YOLO11s + GatedAttnBlock 训练脚本 - 水稻+玉米 19 类
门控 + CBAM 注意力 + 残差，轻量 Neck 增强。
"""
import os
...
MODEL_YAML = PROJECT_ROOT / "yolo11s_gated_attn_19cls.yaml"
...
RUN_DIR = PROJECT_ROOT / "runs" / "detect" / "ricemaize_19cls_y11s_gated_attn"
...
if __name__ == "__main__":
    ...
    if not DATA_YAML.exists():
        ...
        print("请先运行: python replace_rice_with_new_dataset.py")
        exit(1)
    ...
    if RESUME:
        ...
        print("=" * 70)
        print("从 last.pt 恢复训练（GatedAttn）")
        print("=" * 70)
        ...
        print("=" * 70)
        print("训练 YOLO11s + GatedAttnBlock（门控 + CBAM 注意力 + 残差）")
        print("=" * 70)
    ...
    model.train(
        ...
        name="ricemaize_19cls_y11s_gated_attn",
        exist_ok=True,
    )

    print("\n" + "=" * 70)
    print("训练完成！最佳模型:", PROJECT_ROOT / "runs" / "detect" / "ricemaize_19cls_y11s_gated_attn" / "weights" / "best.pt")
    print("=" * 70)
